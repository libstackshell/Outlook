...
public sealed class Outlook : Model
{
    ...
    public Outlook()
    {
        ...
        routines.Add(new Routine((Type?)null, "outlook.list_stores"));
        routines.Add(new Routine((Type?)null, "outlook.get_default_store"));

        // store_name, folderSpec
        routines.Add(new Routine((Type)null, "outlook.list_folders2", typeof(string), typeof(string)));
        ...
        outlook_list_mails_types.Add(typeof(int));
        routines.Add(new Routine((Type?)null, "outlook.list_mails", outlook_list_mails_types));
        ...
        outlook_get_mail_types.Add(typeof(bool));
        outlook_get_mail_types.Add(typeof(int));
        routines.Add(new Routine((Type?)null, "outlook.get_mail", outlook_get_mail_types));
        ...
        routines.Add(new Routine((Type?)null, "outlook.create_draft2", outlook_create_draft2_types));
        ...
        routines.Add(new Routine((Type?)null, "outlook.search_calendar2", outlook_search_calendar_types));
        ...
        outlook_search_mails2_types.Add(typeof(bool));
        outlook_search_mails2_types.Add(typeof(int));
        routines.Add(new Routine((Type?)null, "outlook.search_mails2", outlook_search_mails2_types));

        // entry_id, store_name?
        routines.Add(new Routine((Type?)null, "outlook.get_calendar_item", typeof(string), typeof(string)));
    ...
    public object? Invoke(string routine, List<object> parameters)
    {
        ...
        {
            "outlook.list_stores" => OutlookInterop.ListStores(),
            "outlook.get_default_store" => OutlookInterop.GetDefaultStore(),

            "outlook.list_folders2" => OutlookInterop.ListFolders2(
                GetString(parameters, 0, required: true)!,
                GetString(parameters, 1, defaultValue: "{root}")!),

            "outlook.list_mails" => OutlookInterop.ListMails(
                GetString(parameters, 0, required: true)!,
            ...
            "outlook.get_mail" => OutlookInterop.GetMailByEntryId(
                GetString(parameters, 0, required: true)!,
            ...
            "outlook.search_mails2" => OutlookInterop.SearchMails2(
                GetString(parameters, 0, required: true)!,
                GetString(parameters, 1, defaultValue: "{inbox}")!,
            ...
            "outlook.create_draft2" => OutlookInterop.CreateDraft2(
                GetString(parameters, 0, required: true)!,
            ...
            "outlook.search_calendar2" => OutlookInterop.SearchCalendar2(
                GetString(parameters, 0, required: true)!,
            ...
            "outlook.get_calendar_item" => OutlookInterop.GetCalendarItemByEntryId(
                GetString(parameters, 0, required: true)!,
